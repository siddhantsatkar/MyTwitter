    ...
    <section class="w3-col m3">
      ...
      <section class="w3-card-2 w3-round w3-white">
        <section class="w3-container">
         <h4 class="w3-center">Dear ${theUser.fullName} : welcome</h4>
         <p class="w3-center">
         
 
<!--    <form method="post" action="Profilepicservlet"
        enctype="multipart/form-data">
         <img src="img/vivek.jpg" class="w3-circle" style="height:106px;width:106px" alt="Avatar">
      ...
      <section class="w3-row-padding">
		...
		<c:if test="${theUser.email == eachtweet.email}"> 
            <section class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
                <p><img src="uploadfiles/${eachtweet.picfilepath}" width="50" height="50"/> ${eachtweet.fullName} [@${eachtweet.nickName}]: ${eachtweet.date} </p>
        <p>${eachtweet.text} </p>
            	<form action="tweetServlet" method="post">
    ...
    <section class="w3-col m2">
      <section class="w3-card-2 w3-round w3-white w3-center">
        <section class="w3-container">
          ...
          <c:forEach items ="${whoToFollow}" var ="eachfollow" >
        <p>${eachfollow.fullName} @${eachfollow.nickName}</p>
        </c:forEach>
          <p><button class="w3-btn w3-btn-block w3-theme-l4">Follow</button></p>
        </section>
      </section>
      <br>
       <!-- End Right Column -->
